...
function freelancer_portfolio_header_reset_settings() {
    ...
    remove_theme_mod('header_stickyheaderbgcolor');
	...
	remove_theme_mod('freelancer_portfolio_header_section_width');
...
// for banner
function freelancer_portfolio_banner_reset_settings() {
    remove_theme_mod('banner_profile_image');
    remove_theme_mod('banner_profilename');	
    remove_theme_mod('banner_heading');
    remove_theme_mod('banner_subheading');
    remove_theme_mod('banner_description');
    remove_theme_mod('banner_phonno');
    remove_theme_mod('banner_email');
    remove_theme_mod('banner_address');
    remove_theme_mod('banner_fblink');
    remove_theme_mod('banner_instalink');
    remove_theme_mod('banner_twitterlink');
    remove_theme_mod('banner_pinterestlink');   
    remove_theme_mod('banner_bottombannertextleft');
    remove_theme_mod('banner_bannerbottomtextright');
	remove_theme_mod('banner_headingcolor');
    remove_theme_mod('banner_subheadingcolor');
    remove_theme_mod('banner_description_color');
    remove_theme_mod('banner_border_color');
    remove_theme_mod('banner_boxbg_color');
    remove_theme_mod('banner_boxicon_color');
    remove_theme_mod('banner_boxtext_color');
    remove_theme_mod('banner_socialicon_color');
    remove_theme_mod('banner_socialiconbg_color');
    remove_theme_mod('freelancer_portfolio_banner_section_width');
    wp_send_json_success(
        array(
            'success' => true,
            'message' => "Reset Completed",
...
add_action( 'wp_ajax_freelancer_portfolio_banner_reset_settings', 'freelancer_portfolio_banner_reset_settings' );
...
function freelancer_portfolio_Service_reset_settings() {
    ...
    remove_theme_mod('freelancer_portfolio_Service_image_height');
    wp_send_json_success(
        array(
            'success' => true,
            'message' => "Reset Completed",
...
function freelancer_portfolio_blog_reset_settings() {
    ...
    remove_theme_mod('freelancer_portfolio_blog_image_height');
    wp_send_json_success(
        array(
            'success' => true,
            'message' => "Reset Completed",
