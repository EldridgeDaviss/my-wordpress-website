<section id="banner-section" class="banners-area home-banners">
	<div class="<?php if(esc_attr(get_theme_mod('freelancer_portfolio_banner_section_width','Box Width')) == 'Full Width'){ ?>container-fluid pd-0 <?php } elseif(esc_attr(get_theme_mod('freelancer_portfolio_banner_section_width','Box Width')) == 'Box Width'){ ?> container <?php }?>">
