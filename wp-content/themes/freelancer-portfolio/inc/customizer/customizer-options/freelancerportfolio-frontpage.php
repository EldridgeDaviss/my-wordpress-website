...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_setting('freelancerportfolio_reset_banner_settings',array(
	'sanitize_callback'   => 'sanitize_text_field'
	));
	$wp_customize->add_control(new freelancerportfolio_Reset_Custom_Control($wp_customize, 'freelancerportfolio_reset_banner_settings',array(
	'type' => 'reset_control',
		'priority' => 1,
	'label' => __('Reset Banner Settings', 'freelancer-portfolio'),
	'description' => 'freelancer_portfolio_banner_reset_settings',
	'section' => 'banner_setting'
	)));
	

	$wp_customize->add_setting('freelancerportfolio_banner_tabs', array(
		'sanitize_callback' => 'wp_kses_post',
	));

	$wp_customize->add_control(new freelancerportfolio_Tab_Control($wp_customize, 'freelancerportfolio_banner_tabs', array(
		'section' => 'banner_setting',
		'priority' => 2,
		'buttons' => array(
		array(
		...
		array(
			...
			'fields' => array(
				...
				'banner_border_color',
				'banner_boxbg_color',
				'banner_boxicon_color',
				'banner_boxtext_color',
				'banner_socialicon_color',
				'banner_socialiconbg_color'
			),
		),
		array(
		  ...
		  'fields' => array(
			  'freelancer_portfolio_banner_section_width',
		  ),
	   )
	...
	// banner headingcolor
	$bannerheadingcolor = esc_html__('#000', 'freelancer-portfolio' );
	$wp_customize->add_setting(
    	'banner_headingcolor',
    	array(
	...
	// banner subheadingcolor
	$bannersubheadingcolor = esc_html__('#FD7F00', 'freelancer-portfolio' );
	$wp_customize->add_setting(
    	'banner_subheadingcolor',
    	array(
	...
	$wp_customize->add_control( 
		'banner_subheadingcolor',
		array(
		    'label'   		=> __('Sub Heading Color','freelancer-portfolio'),
		    'section'		=> 'banner_setting',
			'type' 			=> 'color',
			'transport'         => $selective_refresh,
		)  
	...
	$bannerdescription_color = esc_html__('#828282', 'freelancer-portfolio' );
	$wp_customize->add_setting(
    	'banner_description_color',
    	array(
			'default' => $bannerdescription_color,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 4,
		)
	...
	// banner border_color
	$bannerborder_color = esc_html__('#FD7F00', 'freelancer-portfolio' );
	$wp_customize->add_setting(
    	'banner_border_color',
    	array(
			'default' => $bannerborder_color,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 4,
		)
	...
	$wp_customize->add_control( 
		'banner_border_color',
		array(
		    'label'   		=> __('Border Color','freelancer-portfolio'),
		    'section'		=> 'banner_setting',
			'type' 			=> 'color',
			'transport'         => $selective_refresh,
		)  
	...
	// banner boxbg_color
	$bannerboxbg_color = esc_html__('#fff', 'freelancer-portfolio' );
	$wp_customize->add_setting(
    	'banner_boxbg_color',
    	array(
			'default' => $bannerboxbg_color,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 4,
		)
	...
	// banner boxicon_color
	$bannerboxicon_color = esc_html__('#085953', 'freelancer-portfolio' );
	$wp_customize->add_setting(
    	'banner_boxicon_color',
    	array(
			'default' => $bannerboxicon_color,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 4,
		)
	...
	$wp_customize->add_control( 
		'banner_boxicon_color',
		array(
		    'label'   		=> __('Box Icon Color','freelancer-portfolio'),
		    'section'		=> 'banner_setting',
			'type' 			=> 'color',
			'transport'         => $selective_refresh,
		)  
	...
	// banner boxtext_color
	$bannerboxtext_color = esc_html__('#000', 'freelancer-portfolio' );
	$wp_customize->add_setting(
    	'banner_boxtext_color',
    	array(
			'default' => $bannerboxtext_color,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 4,
		)
	...
	$wp_customize->add_control( 
		'banner_boxtext_color',
		array(
		    'label'   		=> __('Box Text Color','freelancer-portfolio'),
		    'section'		=> 'banner_setting',
			'type' 			=> 'color',
			'transport'         => $selective_refresh,
		)  
	...
	// banner socialicon_color
	$bannersocialicon_color = esc_html__('#fff', 'freelancer-portfolio' );
	$wp_customize->add_setting(
    	'banner_socialicon_color',
    	array(
			'default' => $bannersocialicon_color,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 4,
		)
	...
	$wp_customize->add_control( 
		'banner_socialicon_color',
		array(
		    'label'   		=> __('Social Icon Color','freelancer-portfolio'),
		    'section'		=> 'banner_setting',
			'type' 			=> 'color',
			'transport'         => $selective_refresh,
		)  
	...
	// banner socialiconbg_color
	$bannersocialiconbg_color = esc_html__('#FD7F00', 'freelancer-portfolio' );
	$wp_customize->add_setting(
    	'banner_socialiconbg_color',
    	array(
			'default' => $bannersocialiconbg_color,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 4,
		)
	...
	$wp_customize->add_control( 
		'banner_socialiconbg_color',
		array(
		    'label'   		=> __('Social Icon BG Color','freelancer-portfolio'),
		    'section'		=> 'banner_setting',
			'type' 			=> 'color',
			'transport'         => $selective_refresh,
		)  
	...
	// layout setting
	$wp_customize->add_setting('freelancer_portfolio_banner_section_width',array(
        'default' => 'Box Width',
        'sanitize_callback' => 'freelancerportfolio_sanitize_choices',
    ));
    $wp_customize->add_control('freelancer_portfolio_banner_section_width',array(
        'type' => 'select',
	   ...
	   'buttons' => array(
  		...
  		array(
	        ...
	        'fields' => array(
				...
				'freelancer_portfolio_Service_image_height'
	        ),
     	)
	...
	// Service img height
    $wp_customize->add_setting('freelancer_portfolio_Service_image_height',array(
        'default' => 280,
        'sanitize_callback' => 'freelancerportfolio_sanitize_float'
    ));
    $wp_customize->add_control(new freelancerportfolio_Custom_Control( $wp_customize, 'freelancer_portfolio_Service_image_height',array(
	    'label' => __('Image Height','freelancer-portfolio'),
	    'section' => 'Service_setting',
	    'input_attrs' => array(
	            'min' => 0,
	            'max' => 500,
	   ...
	   'buttons' => array(
		 ...
		 array(
	        ...
	        'fields' => array(
				...
				'freelancer_portfolio_blog_image_height'
	        ),
     	)
	...
	// blog img height
    $wp_customize->add_setting('freelancer_portfolio_blog_image_height',array(
        'default' => 250,
        'sanitize_callback' => 'freelancerportfolio_sanitize_float'
    ));
    $wp_customize->add_control(new freelancerportfolio_Custom_Control( $wp_customize, 'freelancer_portfolio_blog_image_height',array(
	    'label' => __('Image Height','freelancer-portfolio'),
	    'section' => 'blog_setting',
	    'input_attrs' => array(
	            'min' => 0,
